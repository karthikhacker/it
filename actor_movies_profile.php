...
<?php include("inc/nav.php"); ?>
 ...
 <div class="container">
 	<div class="row">
      ...
      $movie = "SELECT * FROM  actor_movie_profile  WHERE  movies_id = '$id' ";
     ...
     <table class="table">
        ...
        <tr>
          ...
          <td><b><a id='subject' href='actor_profile.php?subjectp_id=1'><?php echo $starring_actor; ?></a></b>,   <b><a id="subject" href=''><?php echo $starring_actress; ?></a></b></td>          
        </tr>
        <tr>
