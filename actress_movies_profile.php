 ...
 <div class="container">
 	<div class="row">
 		<div class="col-md-7">
 			...
 			<h3>Movie profile</h3>
 			<?php
             if(isset($_GET['actress_movies_id'])){
             $id = $_GET['actress_movies_id'];

      $movie = "SELECT * FROM  actress_movie_profile  WHERE  actress_movies_id = '$id' ";
     ...
     <table class="table">
        ...
        <tr>
          ...
          <td><b><a id='subject' href=''><?php echo $starring_actor; ?></a></b>,   <b><a id="subject" href='actress_profile.php?subjectp_id=1'><?php echo $starring_actress; ?></a></b></td>          
        </tr>
        <tr>
